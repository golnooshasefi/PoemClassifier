...
def PoemparsBertClassifier(text):
    path = "C:\\Users\\Golnoosh\\Desktop\\University\\Sem8\\Final Project\\Final-Models\\GhazalRobaeeModels\\GhazalRobaeeParsBERT\\GhazalRobaeeParsBERT\\weights"
    global normalizer 
    ...
    new_Final_output = tf.keras.layers.Dense(6, activation ='softmax', trainable=True)(modelResult)
    ...
    # df = pd.DataFrame({'lab': idToLabel , 'val': prb[0]})
